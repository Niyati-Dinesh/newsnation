  ...
  render() {
    return (
      <div className="flex flex-col min-h-screen font-sora text-white">
        ...
        <footer className="text-center py-4 text-sm bg-zinc-950/50 backdrop-blur-md shadow-inner mt-auto">
          Created with <span className="text-pink-400">&lt;3</span> by <span className="font-semibold">Niyati</span>
        </footer>
      </div>
    );
  }
